...
function preload() {
  ...
  this.load.image("explosion1", "assets/sprites/explosion/explosion-f1.png");
  this.load.image("explosion2", "assets/sprites/explosion/explosion-f2.png");
  this.load.image("explosion3", "assets/sprites/explosion/explosion-f3.png");
  this.load.image("explosion4", "assets/sprites/explosion/explosion-f4.png");
  this.load.image("explosion5", "assets/sprites/explosion/explosion-f5.png");
  this.load.image("explosion6", "assets/sprites/explosion/explosion-f6.png");
  this.load.image("explosion7", "assets/sprites/explosion/explosion-f7.png");
  this.load.image("explosion8", "assets/sprites/explosion/explosion-f8.png");
  this.load.image("pillar", "assets/sprites/pipe.png");
...
function create() {
  ...
  this.input.on("pointerdown", function (pointer) {
    ...
    scoreText = this.add.text(game.config.width / 2, 30, "0", {fontSize: "32px",fontFamily: "Verdana", fill: "#730c6e",});
...
function hitBase(character, base) {
  ...
  finalScoreText = this.add.text(game.config.width / 2, game.config.height, score, { fontSize: "32px", fontFamily: "Verdana", fill: "#730c6e" });
